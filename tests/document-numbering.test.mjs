...
const indexedValues = [
  { kind: 'invoice', prefix: 'F', year: 2026, sequence: 15, source: 'drive.index' },
  { value: 'F-2026-012.json', source: 'drive.name' }
];
assert.equal(numbering.highest('invoice', '2026', indexedValues), 15);
assert.equal(numbering.next('invoice', '2026', indexedValues), 'F-2026-016');
