...
const list=BastMailHistory.add([],{docKey:'invoice',doc:{documentNumber:'F-001',clientName:'Client'},to:'client@example.com',subject:'Facture',attachmentFileId:'drive-pdf-1',attachmentDriveName:'mail-pdf-1.pdf'},{now:()=>now,createId:()=> 'mail-1'});
...
assert.equal(list[0].attachmentFileId,'drive-pdf-1');
